...
exports.useFacebookEvents = exports.FacebookEventProvider = exports.FacebookEventTrackerContext = void 0;
...
var FacebookEventProvider = function (_a) {
    ...
    var fbTracker = (new index_1.default(config.pixelId, config.testCode, config.dev));
